...
- **edgeFaultDetection.py**: adds inspection annotations, measurements, and pass/fail onto live cam
- **framesCR.py**: saves frames as images from cam over 7 seconds, used towards training in RoboFlow and for YOLO classification model
